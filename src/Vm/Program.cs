...
{
    /// <summary>
    /// Represents a regulare expression compiled to a list of instructions.
    /// </summary>
    /// <typeparam name="TokenType"></typeparam>
    public class Program<TokenType> : List<Instruction>
    {
        public Program()
        {
            //
        ...
        public void Print()
        {
            Console.WriteLine("Program - Instructions Count: " + Count);
